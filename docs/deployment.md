...
it requires `CLOUDBASE_READS_ENABLED=true` and migrations 0012 through 0047
...
reapplied; 0044 the Task duration; 0045 the Task repeat rule; 0046 the manual order of Tasks and Reminders; 0047 the language kept on the account). With `CHRONELLE_BACKEND=postgres` (the default) the two
