...
it requires `CLOUDBASE_READS_ENABLED=true` and migrations 0012 through 0039
...
Task assignee; 0039 the Task location). With `CHRONELLE_BACKEND=postgres` (the default) the two
