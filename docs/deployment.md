...
it requires `CLOUDBASE_READS_ENABLED=true` and migrations 0012 through 0040
...
Task assignee; 0039 the Task location; 0040 People in Events). With `CHRONELLE_BACKEND=postgres` (the default) the two
