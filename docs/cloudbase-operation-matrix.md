...
| Relationship changes                 | Include, attach, paid-for, and removed-link relations  | Both endpoints remain independent objects; relation audit and authorization                            | PostgreSQL; `chronelle_relation_create` (migration 0016) exists for the create shape, the route is not yet ported                          |
